...
provider "local/lukekaalim/aws-eb" {
  version     = "0.1.0"
  constraints = "0.1.0"
  hashes = [
    "h1:XfnXvHltUcf9tqbRZakqk4MTNxUWsjgbpA9oI+6CsHM=",
  ]
}

provider "local/lukekaalim/immutable-elastic-beanstalk" {
  version     = "0.1.0"
  constraints = "0.1.0"
  hashes = [
    "h1:4nwTZCsoY5g1oyurT99KVot4sW97vugEsLQEookjDJ0=",
  ]
}
